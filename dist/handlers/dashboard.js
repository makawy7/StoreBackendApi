...
var orderProducts = new dashboard_1.DashboardQueries();
// get orders of the logged in user
var getOrders = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, orders, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                user = verifyAuthToken_1.default.getLoggedInUser(req);
                return [4 /*yield*/, orderProducts.productsInOrder(user.id)];
            case 1:
                orders = _a.sent();
                res.status(200);
                if (orders == null) {
            ...
            case 2:
                err_1 = _a.sent();
                res.status(401);
                res.json("Error while retreiving user order: ".concat(err_1));
                return [3 /*break*/, 3];
...
var dashboardRoutes = function (app) {
    app.get('/orders', verifyAuthToken_1.default.verifyAuthToken, getOrders);
};
