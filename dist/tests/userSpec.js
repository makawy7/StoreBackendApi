...
var pStore = new user_1.UserStore();
describe("User Model", function () {
    ...
    it('create method should add a user', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, pStore.create({
                        username: 'abdallah',
                        firstname: 'abdallah',
                        lastname: 'mekawy',
    ...
    it('authenticate method should return the logged in user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, pStore.authenticate("abdallah", "password123")];
                case 1:
                    result = _a.sent();
                    expect(result).toBeDefined();
                    return [2 /*return*/];
    ...
    it('show method should return the correct user', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, pStore.show("1")];
                case 1:
                    result = _a.sent();
                    expect(result).toBeDefined();
                    return [2 /*return*/];
