...
var dStore = new dashboard_1.DashboardQueries();
describe("DashboardQueries Model", function () {
    ...
    it('productsInOrder should return orders by user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var user_id, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    user_id = 9;
                    return [4 /*yield*/, dStore.productsInOrder(user_id)];
                case 1:
                    result = _a.sent();
